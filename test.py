...
path = 'D:/AIM/2. Gender-Age Detection/Datasets/IMDB-WIKI/'
#imdb_mat = path + 'imdb_crop/imdb.mat'
wiki_mat = path + 'wiki_crop/wiki.mat'
...
final_wiki = np.vstack((wiki_age, wiki_path)).T
